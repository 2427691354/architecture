    ...
    public static void startServer(String HOST,Integer PORT){
        ...
        serverBootstrap.childHandler(new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel channel) throws Exception {
                ...
                pipeline.addLast("TCPHandler1",new TCPHandler());
                pipeline.addLast("TCPHandler2",new TCPHandler2());
        ...
        //7.绑定ip和port
        try {
            ChannelFuture channelFuture = serverBootstrap.bind(HOST, PORT).sync();//Future模式的channel对象
            //7.5.监听关闭
